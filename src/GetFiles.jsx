    ...
    const fetchFiles = async () => {
        try {
            const response = await customFetch(`http://${key}:18080/user_files`, {
                ...
                body: JSON.stringify({
                    'file_fields': ["path", "content_type", "size", "name", "extension", "favourite", "created", "modified", "owner"], 
                    'folder_fields': ["path", "type", "size", "name", "color", "favourite", "created", "modified", "owner"]
                })
            })
